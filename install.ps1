...
#   irm https://github.com/chipwolf/dotfiles/releases/download/v1.3.0/install.ps1 | iex # x-release-please-version
# Or clone the repo and run:
#   .\install.ps1

$repoUrl = "https://github.com/chipwolf/dotfiles"
$rawBase = "https://github.com/chipwolf/dotfiles/releases/download/v1.3.0" # x-release-please-version
