...
<!-- x-release-please-start-version -->
```powershell
irm https://github.com/chipwolf/dotfiles/releases/download/v1.0.0/install.ps1 | iex
```
<!-- x-release-please-end -->
...
- **Install scripts** (`install.sh`, `install.ps1`): published as [GitHub Release](https://github.com/chipwolf/dotfiles/releases/tag/v1.0.0) assets with generic SLSA provenance. <!-- x-release-please-version -->
...
# Container image
gh attestation verify oci://ghcr.io/chipwolf/dotfiles:v1.0.0 --owner chipwolf
```
<!-- x-release-please-end -->
